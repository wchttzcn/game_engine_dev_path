...
veriyor: skordan sonra top kendiliğinden servise çıkıyor. Bu dersin işi o
...
olsun. `Playing` sırasında 1.5–1.10'da kurduğun top hareketi, collision ve skor
kuralları çalışsın. Skor artırıldıktan sonra reset'i çağır ve state'i yeniden
`Serving` yap.
...
açık hale getiriyorsun. 1.10'daki reset, “skordan sonra ne oluyor?” sorusuna
...
skor bloğunu olduğu gibi sarar.
:::

::: details İpucu 3 — Reset'ten sonra ne olacak?
Skoru artırıp reset'i çağırdığın satırın hemen ardına
