---
title: "1.39 — Level up parıltısı çiz"
...
1.19'daki iyileştirme de yukarı gidiyordu ama dar kalıyordu: bir kişiye yapılan bir iş. Level up ise genişler; olay karakterden taşar. Aynı yönü farklı genişlikle kullanmak, iki efekti birbirinden ayırmaya yeter.
...
Sonraki adım: [1.40 — Tek slime'dan üç tier üret](/pixel-art/40-slime-tiers).
