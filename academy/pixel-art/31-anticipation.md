...
Pakette yazılı ders bitti ama yol bitmedi. [Yol haritası](/pixel-art/roadmap) hangi konuların ders olarak yazılabileceğini gruplar; [Idle RPG görsel seti](/pixel-art/idle-kit) parçaların bir arada nasıl durduğunu gösterir. Yeni bir asset çizdiğinde [1.64 — Asset'lerini tek sprite sheet'e topla](/pixel-art/64-sprite-sheet) dersindeki kit'e bir frame eklemen yeterli.
:::
...
**Kazanım:** Bir hareketi başı, ortası ve sonu olan bir olaya dönüştürebiliyorsun. Bundan sonrası, çizdiklerini 1.64'teki kit'e eklemek ve idle oyununda kullanmak.
