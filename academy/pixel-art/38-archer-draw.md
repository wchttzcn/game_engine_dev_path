---
title: "1.38 — Archer'ın yay germe pozunu çiz"
...
1.37'de çizdiğin archer'ı yeni bir 8×8 dosyaya kopyala ve yalnız sağ tarafını değiştir: yay dışa taşınsın, elin geri gelsin ve kirişe bir ok ucu otursun. `art/characters/archer-draw.aseprite` olarak kaydet.
...
<div class="pixel-steps">
  <figure>
    <div class="pixel-canvas"><img src="/pixel-art/fx/archer-base.svg" width="128" height="128" style="background-image:linear-gradient(to right,#486452 1px,transparent 1px),linear-gradient(to bottom,#486452 1px,transparent 1px);background-size:16px 16px;outline:1px solid #486452" alt="1.37'deki duran archer; yay sağda kavisli." /></div>
    <figcaption><strong>1 · Duran poz</strong><br />Önce 1.37'deki archer'ı aynen kopyala. Bu senin referansın.</figcaption>
  </figure>
  <figure>
...
Yay 8. sütunda 2–7. satırlar. El 6. sütunda 5. satır, ok ucu 7. sütunda 5. satır. Diğer her şey 1.37 ile aynı.
:::
...
Sonraki adım: [1.39 — 8×8 ok çiz](/pixel-art/39-arrow).
