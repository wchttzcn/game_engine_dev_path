...
1.34'teki iyileştirme yukarı doğru yükseliyordu. Koruma ise **hiçbir yere gitmez;** karakterin etrafında durur. Bu fark biçimle anlatılır: yükselen parçacık yerine kapalı bir çember.
...
Sonraki adım: [1.36 — 8×8 archer çiz](/pixel-art/36-archer).
