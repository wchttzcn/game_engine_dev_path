---
title: "1.74 — Kilitli slot ve artı düğmesi çiz"
...
1.72'deki slotu iki kez çoğalt. Birincisinde çerçeveyi soluklaştır ve ortasına kilit işareti koy; ikincisinde ortasına `#ffe5a3` renginde artı koy. `art/idle-ui/slot-states.aseprite` olarak kaydet.
...
**“Pixel Art 1.74 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.75 — 24×12 düğme durumları çiz](/pixel-art/75-button-states).
