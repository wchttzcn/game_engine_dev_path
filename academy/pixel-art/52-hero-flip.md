...
1.39'daki archer'ı 8×8 yeni bir dosyaya kopyala ve `Edit > Flip Horizontal` (`Shift+H`) ile çevir. İki hâli yan yana koy, yayın ve elin hangi tarafa geçtiğini not et. `art/characters/archer-left.aseprite` olarak kaydet.
...
<div class="pixel-steps">
  <figure>
    ...
    <figcaption><strong>1 · Özgün yön</strong><br />1.39'daki archer. Yay sağda, yani atış yönünde.</figcaption>
  </figure>
  <figure>
