---
title: "1.67 — Kilitli slot ve artı düğmesi çiz"
...
**Önce şu teknik:** [1.11 — Üç value ile ayır](/pixel-art/11-value) — Açık ve kapalı durumu parlaklık farkı kurar.

## Görev

1.65'teki slotu iki kez çoğalt. Birincisinde çerçeveyi soluklaştır ve ortasına kilit işareti koy; ikincisinde ortasına `#ffe5a3` renginde artı koy. `art/idle-ui/slot-states.aseprite` olarak kaydet.
...
**“Pixel Art 1.67 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.68 — 24×12 düğme durumları çiz](/pixel-art/68-button-states).
