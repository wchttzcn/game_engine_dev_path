---
title: "1.41 — Karakteri ve efekti aynı zaman çizgisine koy"
...
Hazırlık frame'ini uzat, çıkış frame'ini kısalt. Ağırlığı 1.31'deki gibi süre kurar.
:::
...
Sonraki adım: [1.42 — 8×8 armor ikonu çiz](/pixel-art/42-armor).
