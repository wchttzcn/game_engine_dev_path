...
1.58'deki slime'ı 8×8 yeni bir dosyaya kopyala ve iki frame kur. İlk frame normal renkleriyle kalsın; ikinci frame'de bütün dolu pixel'ler `#ffe5a3` olsun. Süreler 320 ve 60 ms olsun. `art/fx/hit-flash.aseprite` olarak kaydet.
...
Siluet 1.58'deki slime ile birebir aynı. Flash frame'inde gözün koyu pixel'leri de açık renge boyanır.
:::
...
**“Pixel Art 1.64 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.65 — Kritik vuruşu ayır](/pixel-art/65-crit).
