---
title: "1.55 — Level up parıltısı çiz"
...
1.34'teki iyileştirme de yukarı gidiyordu ama dar kalıyordu: bir kişiye yapılan bir iş. Level up ise genişler; olay karakterden taşar. Aynı yönü farklı genişlikle kullanmak, iki efekti birbirinden ayırmaya yeter.
...
Sonraki adım: [1.56 — 32×8 can barı çiz](/pixel-art/56-health-bar).
