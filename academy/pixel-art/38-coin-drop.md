...
8×8 transparent RGB dosyada dört frame kur. 1.21'deki coin'i her frame'de farklı yükseklikte göster; son frame'de yalnız birkaç pixel kalsın. Frame süreleri 80, 110, 90 ve 200 ms olsun. `art/fx/coin-drop.aseprite` olarak kaydet.
...
Sonraki adım: [1.39 — Level up parıltısı çiz](/pixel-art/39-level-up).
