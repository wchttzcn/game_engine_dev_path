---
title: "1.68 — Süzülen hasar sayısını çiz"
description: "1.22'deki rakamları yukarı süzüp kaybederek vuruşu sayıyla göster."
...
**Önce şu teknik:** [1.22 — 3×5 rakam seti çiz](/pixel-art/22-digits) — Sayı yeniden çizilmez; hazır rakam seti taşınır.
...
- Rakamlar 1.22'deki setle birebir aynı; yeniden çizilmemiş.
...
Rakamları yeniden çizme; 1.22'deki seti kopyala. Kendi elinle çizmek her seferinde farklı çıkar.
:::
...
**“Pixel Art 1.68 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.69 — Level up parıltısı çiz](/pixel-art/69-level-up).
