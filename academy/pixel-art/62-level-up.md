---
title: "1.62 — Level up parıltısı çiz"
...
1.35'teki iyileştirme de yukarı gidiyordu ama dar kalıyordu: bir kişiye yapılan bir iş. Level up ise genişler; olay karakterden taşar. Aynı yönü farklı genişlikle kullanmak, iki efekti birbirinden ayırmaya yeter.
...
Sonraki adım: [1.63 — 32×8 can barı çiz](/pixel-art/63-health-bar).
