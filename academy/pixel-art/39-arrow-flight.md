---
title: "1.39 — Okun uçuşunu iki frame'de göster"
...
**Önce şu teknik:** [1.15 — Sandığı iki frame ile aç](/pixel-art/15-chest-open) — Sabit sprite, değişen konum: hareketin en yalın hâli.
...
1.38'deki ok kenardan kenara sekiz pixel kaplıyor. O sprite'ı hareket ettirmeye kalkarsan bir ucu canvas dışında kalır. **8×8'de hareket, boşluk ister.**
...
**“Pixel Art 1.39 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.40 — Archer için isabet parıltısı çiz](/pixel-art/40-archer-impact).
