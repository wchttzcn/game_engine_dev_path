---
title: "1.10 — Kenarlığın farkını gör"
...
1.7'deki sandığı 8×8 bir dosyaya kopyala ve arkasını `#3b6149` ile doldur. İkinci bir frame'de aynı sandığa `Edit > FX > Outline` ile `#182e33` renginde dış kenarlık ekle. İki frame'i karşılaştır ve `art/craft/outline-test.aseprite` olarak kaydet.

## Ne zaman bitti?

- İki frame'de de sandık aynı ve arka alan aynı yeşil.
- İkinci frame'de kenarlık sprite'ın dışında, tek pixel kalınlığında.
- Kenarlık rengi hem sandıktan hem zeminden koyu; kaynak 8×8.

## Bilmen gereken küçük parça

Bir sprite'ın zeminden ayrılması her zaman kolay değil. Yeşil zeminde yeşil bir şekil, mor zeminde mor bir şekil kaybolur. **Kenarlık bu sorunu çözer:** sprite'ın çevresine koyu bir çizgi koyar ve şekli zeminden koparır.
...
`Edit > FX > Outline` penceresinde kenarlığın rengini ve dışa mı içe mi çizileceğini seçebilirsin. İçe çizmek 8×8'de sprite'ı yer; dışa çizmek ise canvas'ta yer ister. Kararı her sprite için ayrı ayrı vereceksin: envanterdeki bir ikonun kenarlığa ihtiyacı olmayabilir, çimenin üstünde duran bir karakterin olur.
...
Sonraki adım: [1.11 — Üç value ile ayır](/pixel-art/11-value).
