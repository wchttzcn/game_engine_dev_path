---
title: "1.73 — Yokken kazandıkların ekranını kur"
...
**Önce şu teknik:** [1.22 — 3×5 harf seti çiz](/pixel-art/22-letters) — Başlık ve kazanç satırları bu harf setiyle yazılır.
...
Altın satırının yanındaki `X2` rozeti, offline kazancın bir çarpanla arttığını söyler — 1.70'te çizdiğin rozet burada ikinci kez iş görüyor. Bu, iyi bir UI parçasının işareti: bir kez çizilir, birçok yerde kullanılır.
...
Sonraki adım: [1.74 — 32×16 kamp alanı kur](/pixel-art/74-camp).
