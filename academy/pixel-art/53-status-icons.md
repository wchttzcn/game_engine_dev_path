---
title: "1.53 — Durum etkisi ikonlarını çiz"
...
Bu ikonlar karakterin üstünde veya can barının yanında küçük bir rozet olarak görünür. Aynı seti büyütmek kolay: kalkan için 1.36'daki kubbenin küçük hâli, hız için bir ok işareti. Kural aynı kalır — biçim ve renk birlikte ayırsın.
...
Sonraki adım: [1.54 — 8×8 slime çiz](/pixel-art/54-slime).
