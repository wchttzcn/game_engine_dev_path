...
1.48'deki slime'ı 8×8 yeni bir dosyaya kopyala ve iki frame kur. İlk frame normal renkleriyle kalsın; ikinci frame'de bütün dolu pixel'ler `#ffe5a3` olsun. Süreler 320 ve 60 ms olsun. `art/fx/hit-flash.aseprite` olarak kaydet.
...
Siluet 1.48'deki slime ile birebir aynı. Flash frame'inde gözün koyu pixel'leri de açık renge boyanır.
:::
...
Sonraki adım: [1.53 — Slime'ın ölüşünü çiz](/pixel-art/53-slime-death).
