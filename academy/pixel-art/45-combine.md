---
title: "1.45 — Mage'i ve büyüsünü aynı zaman çizgisine koy"
...
<PixelAnimation title="Mage — karakter ve efekt birlikte" :columns="16" :rows="8" :frames='[{"src":"/pixel-art/craft/combine-1.svg","label":"Duruş","duration":220,"alt":"Mage duruyor; ekranda efekt yok."},{"src":"/pixel-art/craft/combine-2.svg","label":"Hazırlık","duration":140,"alt":"Mage kolunu kaldırdı; elinde ışık toplandı."},{"src":"/pixel-art/craft/combine-3.svg","label":"Çıkış","duration":110,"alt":"Mage aynı pozda; büyü elden ayrılmış."},{"src":"/pixel-art/craft/combine-4.svg","label":"Dönüş","duration":400,"alt":"Mage duruşuna döndü; büyü yoluna devam ediyor."}]' />
...
Hazırlık frame'ini uzat, çıkış frame'ini kısalt. Ağırlığı 1.34'teki gibi süre kurar.
:::
...
- [1.46 — Warrior'ı ve kılıç izini birleştir](/pixel-art/46-warrior-combine):
  iz karakterden **ayrılmaz**, onunla birlikte belirir ve birlikte söner.
- [1.47 — Priest'i ve iyileştirmesini birleştir](/pixel-art/47-priest-combine):
  parıltı yukarı gittiği için canvas 8×16 olur — **yönü efekt belirler**.
- [1.48 — Archer'ı, okunu ve isabetini birleştir](/pixel-art/48-archer-combine):
...
Sonraki adım: [1.46 — Warrior'ı ve kılıç izini birleştir](/pixel-art/46-warrior-combine).
