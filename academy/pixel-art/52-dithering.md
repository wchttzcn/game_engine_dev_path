---
title: "1.52 — Dithering ile geçiş yap"
...
Deseni elle koymak yerine iki renk arasında seçim yapıp tek tek pixel koymak da olur; önemli olan desenin düzenli olması. Aynı yöntem 1.49'daki mağarada zemin ile duvar arasında veya kamp zemininde de kullanılabilir.
...
Sonraki adım: [1.53 — Aynı iki frame'i üç süreyle dene](/pixel-art/53-timing).
