---
title: "1.51 — Level up parıltısı çiz"
...
1.33'teki iyileştirme de yukarı gidiyordu ama dar kalıyordu: bir kişiye yapılan bir iş. Level up ise genişler; olay karakterden taşar. Aynı yönü farklı genişlikle kullanmak, iki efekti birbirinden ayırmaya yeter.
...
Sonraki adım: [1.52 — 32×8 can barı çiz](/pixel-art/52-health-bar).
