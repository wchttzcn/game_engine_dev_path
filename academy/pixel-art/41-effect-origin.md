---
title: "1.41 — Efekt karakterin neresinden çıkar?"
...
Kılıcını savurduğu taraf. 1.30'daki iz hangi tarafta belirdiyse çıkış noktası orasıdır.
:::
...
Sonraki adım: [1.42 — Mage'i ve büyüsünü aynı zaman çizgisine koy](/pixel-art/42-combine).
