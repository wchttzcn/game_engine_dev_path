...
| --- | --- | --- |
| Mage | [1.17 — Mage için büyü atışı çiz](/pixel-art/17-mage-bolt) | Ateş için kıvrılan kuyruk; buz için köşeli uç. Önce yalnız şekli değiştir. |
| Warrior | [1.18 — Warrior için kılıç izi çiz](/pixel-art/18-warrior-slash) | Güçlü vuruş için daha uzun hazırlık; hızlı vuruş için daha kısa iz. Önce yalnız süreyi değiştir. |
| Priest | [1.19 — Priest için iyileştirme çiz](/pixel-art/19-priest-heal) | Koruma için karakterin yanında kısa süre kalan bir yay. Yukarı yükselmek yerine yerinde durmayı dene. |
| Archer | [1.20 — Archer için isabet parıltısı çiz](/pixel-art/20-archer-impact) | Sert yüzeyde kısa kıvılcım veya yerde dışa açılan toz. Önce yalnız dağılan parçaların yönünü seç. |
