...
1.22'de rakamları çizdin; artık altın miktarını yazabiliyorsun. Ama bir düğmenin üstünde `SHOP`, bir eşyanın yanında `RING` yazması için **harflere** ihtiyacın var.
...
Harfleri rakamlarla aynı dosyada tutmak işini kolaylaştırır: tek bir metin seti olur ve 1.108'deki kit'e tek grup olarak girer. Küçük harf çizmene gerek yok; bu ölçüde büyük harf hem daha okunur hem daha az iş.
...
Sonraki adım: [1.24 — Türkçe harfleri ekle](/pixel-art/24-letters-tr).
