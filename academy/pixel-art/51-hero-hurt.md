...
1.64'teki flash'ı ve 1.66'daki çöküşü warrior üzerinde kur. 8×8 bir dosyada iki frame'lik hurt (normal ve `#ffe5a3` flash), ayrı bir dosyada dört frame'lik death çiz. `art/characters/warrior-hurt.aseprite` ve `warrior-death.aseprite` olarak kaydet.
