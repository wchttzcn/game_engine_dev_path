---
title: "1.25 — Mage'in büyü yapma pozunu çiz"
...
1.23'teki mage'i yeni bir 8×8 dosyaya kopyala. Sağ üst köşeye doğru uzanan bir kol ekle ve elin ucunda `#9de7f5` renginde tek bir ışık pixel'i bırak. `art/characters/mage-cast.aseprite` olarak kaydet.
...
- Işık rengi 1.26'da kullanacağın büyü rengiyle aynı; kaynak 8×8.
...
<div class="pixel-steps">
  <figure>
    <div class="pixel-canvas"><img src="/pixel-art/fx/mage-base.svg" width="128" height="128" style="background-image:linear-gradient(to right,#486452 1px,transparent 1px),linear-gradient(to bottom,#486452 1px,transparent 1px);background-size:16px 16px;outline:1px solid #486452" alt="1.23'teki duran mage." /></div>
    <figcaption><strong>1 · Duran poz</strong><br />1.23'teki mage'i aynen kopyala. Gövdeye hiç dokunmayacağız.</figcaption>
  </figure>
  <figure>
...
Bu poz büyünün **hazırlık** karesi; 1.18'de sandığın kapağını bastırdığın kareyle aynı işi görür. 1.43'te bu pozu büyü atışıyla aynı zaman çizgisine koyacağız ve mage'in ne zaman duruşuna döneceğine karar vereceğiz.
...
El 6. sütunda 2. satır, ışık 7. sütunda 1. satır. Geri kalan her şey 1.23 ile birebir aynı.
:::
...
**“Pixel Art 1.25 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.26 — Mage için büyü atışı çiz](/pixel-art/26-mage-bolt).
