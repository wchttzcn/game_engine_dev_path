---
title: "1.36 — Priest'in dua pozunu çiz"
...
1.35'teki priest'i yeni bir 8×8 dosyaya kopyala. Asayı bir pixel yukarı taşı ve ucuna `#b7efd0` renginde tek bir ışık pixel'i koy. `art/characters/priest-cast.aseprite` olarak kaydet.
...
- Işık rengi 1.37'de kullanacağın iyileştirme rengiyle aynı; kaynak 8×8.
...
<div class="pixel-steps">
  <figure>
    <div class="pixel-canvas"><img src="/pixel-art/fx/priest-base.svg" width="128" height="128" style="background-image:linear-gradient(to right,#486452 1px,transparent 1px),linear-gradient(to bottom,#486452 1px,transparent 1px);background-size:16px 16px;outline:1px solid #486452" alt="1.35'teki duran priest." /></div>
    <figcaption><strong>1 · Duran poz</strong><br />1.35'teki priest'i aynen kopyala. Cübbeye hiç dokunmayacağız.</figcaption>
  </figure>
  <figure>
...
Bu poz iyileştirmenin **hazırlık** karesi; 1.18'de sandığın kapağını bastırdığın kareyle aynı işi görür. 1.47'de bu pozu parıltıyla aynı zaman çizgisine koyacağız.
...
Asanın ucu 7. sütunda 1. satır, ışık 8. sütunda 1. satır. Geri kalan her şey 1.35 ile aynı.
:::
...
Sonraki adım: [1.37 — Priest için iyileştirme çiz](/pixel-art/37-priest-heal).
