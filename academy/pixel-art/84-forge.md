---
title: "1.84 — 16×16 gelir üreten yapı çiz"
...
Yapı 1.82'deki kampın zemin çizgisine oturur; ağaç ve çadırla aynı satıra basar. Aynı kalıptan ikinci bir yapı çıkarmak kolay: gövde ve zemin aynı kalır, içindeki parlak alan değişir — değirmen için dönen bir çark, ahır için açık bir kapı.
...
**“Pixel Art 1.84 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.85 — Aynı sahnenin gece paletini kur](/pixel-art/85-night).
