---
title: "1.78 — Çarpan rozetini çiz"
...
**Önce şu teknik:** [1.21 — 9-slice çerçeve kur](/pixel-art/21-nine-slice) — Rozet ve kart, köşeleri bozulmadan büyüyen çerçevelerdir.

## Görev

17×11 bir rozet çiz: altın çerçeve, koyu iç alan ve 1.22–1.23'teki setle `X2` yazısı. Sonra 60×16 bir yükseltme kartı kur: solda eşya slotu, ortada rozet, sağda coin ve fiyat. `art/idle-ui/upgrade.aseprite` olarak kaydet.

## Ne zaman bitti?

- Rozetin çerçevesi altın, içi koyu; yazı çerçeveye değmiyor.
- Kart üç bölgeye ayrılmış: ikon, çarpan, fiyat.
- Yazılar 1.22 ve 1.23'teki setlerden; kaynak kaydedilmiş.
...
**“Pixel Art 1.78 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.79 — AUTO anahtarını çiz](/pixel-art/79-auto-toggle).
