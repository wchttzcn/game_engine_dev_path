...
**Önce şu teknik:** [1.22 — 3×5 rakam seti çiz](/pixel-art/22-digits) — Seviye sayısı barın yanında bu rakamlarla yazılır.
...
- Bar 1.70'deki can barından belirgin biçimde ince.
...
Barın 4 pixel yüksekliğinde olması, can barının altına sıkışabilmesi için. Gerçek oyunda dolum miktarını deneyim puanı belirler; seviye sayısı barın yanında 1.22'deki rakamlarla yazılabilir.
...
**“Pixel Art 1.71 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.72 — 12×12 eşya slotu çiz](/pixel-art/72-item-slot).
