...
**Önce şu teknik:** [1.21 — 3×5 rakam seti çiz](/pixel-art/21-digits) — Seviye sayısı barın yanında bu rakamlarla yazılır.
...
- Bar 1.63'teki can barından belirgin biçimde ince.
...
Barın 4 pixel yüksekliğinde olması, can barının altına sıkışabilmesi için. Gerçek oyunda dolum miktarını deneyim puanı belirler; seviye sayısı barın yanında 1.21'deki rakamlarla yazılabilir.
...
Sonraki adım: [1.65 — 12×12 eşya slotu çiz](/pixel-art/65-item-slot).
