---
title: "1.32 — Warrior'ın hazırlık pozunu çiz"
...
1.30'daki warrior'ı yeni bir 8×8 dosyaya kopyala. Soluna geriye çekilmiş bir kılıç ekle ve gövdeyi bir pixel sağa kaydır. Kılıç ağzı için `#cfe0e8`, kabza için `#626080` kullan. `art/characters/warrior-windup.aseprite` olarak kaydet.
...
<div class="pixel-steps">
  <figure>
    <div class="pixel-canvas"><img src="/pixel-art/fx/warrior-base.svg" width="128" height="128" style="background-image:linear-gradient(to right,#486452 1px,transparent 1px),linear-gradient(to bottom,#486452 1px,transparent 1px);background-size:16px 16px;outline:1px solid #486452" alt="1.30'daki duran warrior." /></div>
    <figcaption><strong>1 · Duran poz</strong><br />1.30'daki warrior'ı aynen kopyala; miğfer, yüz ve kalkan yerinde.</figcaption>
  </figure>
  <figure>
...
Kılıcın ağzını gövdeden açık bir renkte tutmak, 8×8'de silahı zırhtan ayırmanın en kolay yolu. Bu poz tek başına da kullanılabilir; 1.34'te aynı pozu vuruş ve duruşla birleştireceğiz.
...
Kılıç ağzı 1. sütunda 1–3. satırlar, kabza 1. sütunda 4. satır. Gövde 1.30'daki hâlinin bir sütun sağa taşınmışı.
:::
...
Sonraki adım: [1.33 — Warrior için kılıç izi çiz](/pixel-art/33-warrior-slash).
