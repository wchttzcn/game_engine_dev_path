---
title: "1.34 — Üç frame ile vuruşa ağırlık ver"
...
1.32'deki hazırlık pozunu, yeni çizeceğin vuruş karesini ve 1.30'daki duruşu 8×8 tek dosyada üç frame olarak birleştir. Frame süreleri 220, 80 ve 400 ms olsun. `art/craft/anticipation.aseprite` olarak kaydet.
...
Kural şu: hazırlık uzun, vuruş kısa, dönüş orta. Vuruşun kısa olması onu hızlı gösterir; hazırlığın uzun olması o hızı hissettirir. Aynı üç kare eşit sürelerle oynatılırsa hareket yine görünür ama darbe kaybolur. Bu dersle 1.32'deki poz ve 1.17'deki süre bilgisi tek bir işte birleşir.
...
Vuruş karesinde kılıcın arkasına bir iz eklemek, tek karede kat edilen yolu anlatır; 1.33'teki kılıç izi dersinin aynı fikri. Üç kare artık başı, ortası ve sonu olan tam bir hareket. Bu yapı yürüyüş, zıplama ve büyü yapma için de aynen kullanılabilir.
...
Hazırlıkta kılıç 1. sütunda 1–4. satırlar. Vuruşta kılıç 8. sütunda 2–4. satırlar ve iz 6–7. sütunlarda. Duruş 1.30'daki warrior ile birebir aynı.
:::
...
Sonraki adım: [1.35 — 8×8 priest çiz](/pixel-art/35-priest).
