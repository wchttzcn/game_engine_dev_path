...
1.63'teki kampın kalıbı şuydu: bir zemin, iki büyük şekil, aralarında boşluk. O kalıp kampa özel değil — **bölge değişir, kalıp kalır.**
...
<div class="pixel-steps">
  ...
  <figure>
    <div class="pixel-canvas"><img src="/pixel-art/idle/camp.svg" width="256" height="128" style="background-image:linear-gradient(to right,#486452 1px,transparent 1px),linear-gradient(to bottom,#486452 1px,transparent 1px);background-size:8px 8px;outline:1px solid #486452" alt="1.63'teki yeşil kamp alanı." /></div>
...
Sonraki adım: [1.65 — Asset'lerini tek sprite sheet'e topla](/pixel-art/65-sprite-sheet).
