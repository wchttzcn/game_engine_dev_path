...
1.49'daki slime'ı 8×8 yeni bir dosyaya kopyala ve iki frame kur. İlk frame normal renkleriyle kalsın; ikinci frame'de bütün dolu pixel'ler `#ffe5a3` olsun. Süreler 320 ve 60 ms olsun. `art/fx/hit-flash.aseprite` olarak kaydet.
...
Siluet 1.49'daki slime ile birebir aynı. Flash frame'inde gözün koyu pixel'leri de açık renge boyanır.
:::
...
Sonraki adım: [1.54 — Slime'ın ölüşünü çiz](/pixel-art/54-slime-death).
