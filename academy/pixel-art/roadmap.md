...
2. **Idle oyun (1.25–1.86).** Aynı teknikleri bu kez oyunun gerçek
...
| 1.50–1.53 · Kadroyu tamamla | Kadroya idle, hurt ve death; sola çevirme ve dört frame'lik yürüyüş | Sabit parça, süre, silüet, ağırlık |
...
| 1.86 · Oyuna bağlan | Tag'li tek sprite sheet | 1.2'deki export |
...
Birleşme noktası 1.86'daki kit. Idle oyunu yazacak kadar ilerlediğinde elinde
