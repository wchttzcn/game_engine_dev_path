---
title: "1.59 — Tek slime'dan üç tier üret"
...
1.58'deki slime'ı üç ayrı 8×8 dosya olarak çoğalt. Gövde rengini sırayla `#7dbd72`, `#92afc3` ve `#aa83bf` yap; göz rengine dokunma. `art/monsters/` altına `slime-green`, `slime-blue` ve `slime-purple` adlarıyla kaydet.
...
`Edit > Replace Color` ile gövde rengini tek adımda değiştirebilirsin; `From` alanına eski rengi, `To` alanına yenisini koy. Aynı üç rengi 1.73'teki eşya tier çerçevelerinde de kullanacağız; böylece monster'ın gücü ile eşyanın değeri aynı dili konuşur.
...
Siluet 1.58 ile birebir aynı; göz 3. satırda 2. ve 7. sütunlarda koyu kalır.
:::
...
Sonraki adım: [1.60 — İki frame'lik bat çiz](/pixel-art/60-bat).
