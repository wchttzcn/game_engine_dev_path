---
title: "1.73 — Eşya slotuna tier rengi ver"
...
1.72'deki 12×12 eşya slotunu dört kez çoğalt. Kenar rengini sırayla `#637980`, `#8ac982`, `#92afc3` ve `#aa83bf` yap; iç alan ve ikon aynı kalsın. `art/idle-ui/tier-frames.aseprite` olarak dört frame kaydet.

## Ne zaman bitti?

- Dört slotta da çerçeve kalınlığı ve iç alan aynı.
- Yalnız kenar rengi değişmiş; ikon hiç değişmemiş.
- Renk sırası 1.59'daki monster tier'larıyla aynı aileden; kaynak 12×12.
...
1.59'da slime'ları yeşil, mavi ve mora boyadık. Aynı sırayı burada kullanmak oyuna tek bir dil kazandırır: mor bir çerçeve ile mor bir slime aynı şeyi söyler. Aynı renk sistemini iki yerde kullanmak, ayrı ayrı güzel iki sistemden daha iyidir.
...
Griden mora doğru açıktan koyuya değil, sıradandan nadire doğru git. Sıra 1.59 ile aynı olmalı.
:::

::: details İpucu 3 — Tam yerleşim
Çerçeve 1. ve 12. sütun ile 1. ve 12. satırlarda. İç alan ve ikon 1.72'deki gibi kalır.
:::
...
**“Pixel Art 1.73 denememi değerlendir”** yaz; çizimini inceleyelim.

Sonraki adım: [1.74 — Kilitli slot ve artı düğmesi çiz](/pixel-art/74-slot-states).
