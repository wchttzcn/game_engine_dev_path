...
**Önce şu teknik:** [1.9 — Silüet testi yap](/pixel-art/09-silhouette-test) — Ok bu kadar küçükken tek belirleyen şey dış şekildir.
...
Archer'ı ve gerilmiş yayını çizdin, ama attığı şey henüz yok. Idle oyunda mermi çoğu zaman **karakterden ayrı bir sprite'tır;** ekranda tek başına uçar.
...
Sonraki adım: [1.40 — Okun uçuşunu iki frame'de göster](/pixel-art/40-arrow-flight).
