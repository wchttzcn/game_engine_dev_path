...
The current authorized pack runs to lesson 1.65 and is split into two phases.
Phase 1 (1.1-1.22) teaches technique on small objects only - key, sword, heart,
...
anticipation, repeatable tiles, 9-slice and the 3x5 digit and letter sets. Phase 2 (1.23-1.65)
...
Mücahit authorized this whole range explicitly; do not extend past 1.65 without
